...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-37378-funcoidal-products-inside-an-inward-re-fa7e4d2c-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-37378"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-37378-funcoidal-products-inside-an-inward-re-fa7e4d2c-v1",
      "problem_contract_sha256": "0fca4b73460b496ba78f32d192bd156f836a7974914eb58bd689b559a008d738",
      "problem_id": "problem:um-opg-37378-funcoidal-products-inside-an-inward-re-fa7e4d2c",
      "route_id": "route:um-opg-37378-funcoidal-products-inside-an-inward-re-fa7e4d2c-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-37378-funcoidal-products-inside-an-inward-re-fa7e4d2c-source-fidelity-01",
      "graph_id": "graph:um-opg-37378-funcoidal-products-inside-an-inward-re-fa7e4d2c-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-37378-funcoidal-products-inside-an-inward-re-fa7e4d2c-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-37378-funcoidal-products-inside-an-inward-re-fa7e4d2c-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture (solved) If $a \\times^{\\mathsf{\\ensuremath{\\operatorname{RLD}}}} b \\subseteq \\left( \\mathsf{\\ensuremath{\\operatorname{RLD}}} \\right)_{\\ensuremath{\\operatorname{in}}} f$ then $a \\times^{\\mathsf{\\ensuremath{\\operatorname{FCD}}}} b \\subseteq f$ for every funcoid $f$ and atomic f.o. $a$ and $b$ on the source and destination of $f$ correspondingly. A stronger conjecture: Conjecture If $\\mathcal{A} \\times^{\\mathsf{\\ensuremath{\\operatorname{RLD}}}} \\mathcal{B} \\subseteq \\left( \\mathsf{\\ensuremath{\\operatorname{RLD}}} \\right)_{\\ensuremath{\\operatorname{in}}} f$ then $\\mathcal{A} \\times^{\\mathsf{\\ensuremath{\\operatorname{FCD}}}} \\mathcal{B} \\subseteq f$ for every funcoid $f$ and $\\mathcal{A} \\in \\mathfrak{F} \\left( \\ensuremath{\\operatorname{Src}}f \\right)$, $\\mathcal{B} \\in \\mathfrak{F} \\left( \\ensuremath{\\operatorname{Dst}}f \\right)$."
          },
          "statement_sha256": "fca4cf5a8edbe364dee45ec835426d49ce33f9ffb2493cab6cbf2a2f01a896e4"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-37378-funcoidal-products-inside-an-inward-re-fa7e4d2c-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-37378-funcoidal-products-inside-an-inward-re-fa7e4d2c-root",
      "route_id": "route:um-opg-37378-funcoidal-products-inside-an-inward-re-fa7e4d2c-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-37378-12ea13657925",
        "url": "https://www.unsolvedmath.com/problems/OPG-37378"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
